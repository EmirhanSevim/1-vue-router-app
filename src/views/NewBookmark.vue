<template>
  <div class="form-area card border p-2">
    <div class="mb-3">
      ...
      <input type="text" v-model="userData.title" class="form-control" id="title" placeholder="Giriniz..." />
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
      ...
      <textarea v-model="userData.description" class="form-control" placeholder="Bu var ya.." id="description" rows="3"></textarea>
    </div>
